...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>DIRECTOR | Leave Details </title>
      ...
      ?>  
                                        ...
                                        <tr>
                                            <td style="font-size:16px;"> <b>Student Name :</b></td>
                                              ...
                                              <td style="font-size:16px;"><b>Stu Id :</b></td>
                                          ...
                                          <tr>
                                             <td style="font-size:16px;"><b>Stu Email id :</b></td>
                                            <td><?php echo htmlentities($result->EmailId);?></td>
                                             <td style="font-size:16px;"><b>Stu Contact No. :</b></td>
