                ...
                <nav class="cyan darken-1">
                    <div class="nav-wrapper row">
                        ...
                        <div class="header-title col s3">
                            <span class="chapter-title">AHMS | AAC HOSTEL MONITORING SYSTEM</span>
                        </div>
            ...
            <aside id="slide-out" class="side-nav white fixed">
                ...
                <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion" style="">
                    ...
                    <li class="no-padding"><a class="waves-effect waves-grey" href="forgot-password.php"><i class="material-icons"></i>Student Password Recovery</a></li>
                       ...
                       <li class="no-padding"><a class="waves-effect waves-grey" href="admin/"><i class="material-icons"></i>Director Login</a></li>

                </ul>
          <div class="footer">
                    <p class="copyright"><a href="http://aactni.edu.in/">AAC </a>©</p>
            ...
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"><h4>AAC HOSTEL MONITORING SYSTEM</h4></div>
 <p style="background-image: url('...\assets\images\2.jpg');">
